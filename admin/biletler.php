...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_status'])) {
    ...
    echo "<script>window.location.href='biletler.php?msg=updated';</script>";
    exit;
}
...
if (isset($_GET['delete_id'])) {
    ...
    $stmt->execute([$del_id]);
    echo "<script>window.location.href='biletler.php?msg=deleted';</script>";
    exit;
}
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
    ...
    <div style="display:flex; gap:10px; align-items:center;">
        <a href="bilet-olustur.php" class="btn" style="background:#2ecc71; color:white; padding:10px 15px; text-decoration:none; border-radius:5px; font-weight:bold; font-size:0.9rem;">
        ...
        <form method="GET" style="display:flex; gap:5px; margin:0;">
            ...
            <?php if($search): ?>
                <a href="biletler.php" class="btn" style="background:#95a5a6; color:white; padding:10px; text-decoration:none; border-radius:5px;"><i class="fas fa-times"></i></a>
            <?php endif; ?>
        </form>
    </div>
</div>
    ...
    <table style="width:100%; border-collapse:collapse;">
        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #eee;">
                ...
                <td style="padding:12px;">
                    <a href="biletler.php?delete_id=<?php echo $ticket['id']; ?>" 
