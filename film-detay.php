...
// 2. Seans Verisini Çek ve GRUPLA
...
// Gruplama İşlemi (Salon Adına Göre)
$grouped = [];
        ...
        <div class="movie-detail-card">
            ...
            <div class="info-wrapper">
                ...
                <div style="margin-top: 20px;">
                   <span class="badge">Aksiyon</span>
                   <span class="badge">Macera</span>
                        ...
                        <div class="hall-card">
                            ...
                            <div class="times-grid">
                                <?php foreach ($seanslar as $seans): ?>
                                    <a href="koltuk-sec.php?id=<?php echo $seans['id']; ?>" class="time-btn">
                                        <span class="time"><?php echo date("H:i", strtotime($seans['start_time'])); ?></span>
                                        <span class="date"><?php echo date("d.m", strtotime($seans['start_time'])); ?></span>
                                        <span class="price"><?php echo $seans['price']; ?> ₺</span>
                                    </a>
                                <?php endforeach; ?>
                            </div>
                        </div>
